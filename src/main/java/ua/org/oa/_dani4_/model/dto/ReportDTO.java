...
public class ReportDTO {
    ...
    public ReportDTO(int book_id, Date rent, int user_id, Date returns) {
    ...
    public boolean equals(Object o) {
        ...
        if (getId() != reportDTO.getId()) return false;
        if (book_id != reportDTO.book_id) return false;
        if (user_id != reportDTO.user_id) return false;
        if (getRent() != null ? !getRent().equals(reportDTO.getRent()) : reportDTO.getRent() != null) return false;
        return getReturns() != null ? getReturns().equals(reportDTO.getReturns()) : reportDTO.getReturns() == null;
