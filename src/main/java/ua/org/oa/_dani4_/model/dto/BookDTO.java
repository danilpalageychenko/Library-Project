...
public class BookDTO {
    ...
    public BookDTO(String author, String title, int count) {
    ...
    public boolean equals(Object o) {
        ...
        if (getId() != bookDTO.getId()) return false;
        if (getCount() != bookDTO.getCount()) return false;
        if (getAuthor() != null ? !getAuthor().equals(bookDTO.getAuthor()) : bookDTO.getAuthor() != null) return false;
        return getTitle() != null ? getTitle().equals(bookDTO.getTitle()) : bookDTO.getTitle() == null;
